...
<body>
    <div class="main-container">
        <a href="/rutinas" class="btn-volver">← Cancelar y volver</a>
        ...
        <div class="card-seccion">
            ...
            <div class="form-group">
                ...
                <textarea id="descripcion_rutina" class="form-control" rows="2" placeholder="Enfocado en hipertrofia..."></textarea>
            </div>
        ...
        <button onclick="guardarRutinaCompleta()" class="btn btn-primario">
